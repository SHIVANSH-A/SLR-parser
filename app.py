...
def slr_parser(input_string, parsing_table, grammar):
    ...
    while True:
        ...
        if action == "accept":
            ...
            for _ in range(len(rhs_tokens) * 2):
                stack.pop()
            current_state = stack[-1]
            stack.append(lhs)
...
def index():
    if request.method == 'POST':
        try:
            print("Form submitted!")  # Check if this appears in the console
            
            parsing_table_input = request.form['parsing_table']
            grammar_rules_input = request.form['grammar_rules']
            input_string = request.form['input_string']

            print("Parsing Table:", parsing_table_input)  # Debugging
            print("Grammar Rules:", grammar_rules_input)  # Debugging
            print("Input String:", input_string)  # Debugging
            ...
            print("Error:", e)  # Print the error in the console
